...
ARG VITE_STUDIO_STANDALONE=true
...
ENV VITE_STUDIO_STANDALONE=$VITE_STUDIO_STANDALONE
...
COPY scripts/studio-service ./scripts/studio-service
COPY public ./library
