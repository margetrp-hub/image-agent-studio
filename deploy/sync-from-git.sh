...
STUDIO_PROVIDER_TYPE="${STUDIO_PROVIDER_TYPE:-openai-compatible}"
STUDIO_PROVIDER_BASE_URL="${STUDIO_PROVIDER_BASE_URL:-}"
...
STUDIO_SESSION_QUEUE_LIMIT="${STUDIO_SESSION_QUEUE_LIMIT:-0}"
STUDIO_JOB_LIMIT="${STUDIO_JOB_LIMIT:-0}"
STUDIO_JOB_CONCURRENCY="${STUDIO_JOB_CONCURRENCY:-0}"
STUDIO_VIDEO_POLL_MAX_TRANSIENT_FAILURES="${STUDIO_VIDEO_POLL_MAX_TRANSIENT_FAILURES:-450}"
...
Environment="STUDIO_CREDITS_ENABLED=false"
Environment="STUDIO_USER_PROVIDER_ONLY=true"
Environment="STUDIO_PROVIDER_TYPE=$STUDIO_PROVIDER_TYPE"
Environment="STUDIO_PROVIDER_BASE_URL=$STUDIO_PROVIDER_BASE_URL"
...
Environment="STUDIO_SESSION_QUEUE_LIMIT=$STUDIO_SESSION_QUEUE_LIMIT"
Environment="STUDIO_JOB_LIMIT=$STUDIO_JOB_LIMIT"
Environment="STUDIO_JOB_CONCURRENCY=$STUDIO_JOB_CONCURRENCY"
Environment="STUDIO_VIDEO_POLL_MAX_TRANSIENT_FAILURES=$STUDIO_VIDEO_POLL_MAX_TRANSIENT_FAILURES"
EOF
