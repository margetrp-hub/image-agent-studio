...
assert(history.environment?.STUDIO_JOB_CONCURRENCY === '0', 'studio-history must default to no Workbench-side concurrency cap with an explicit environment override.', history.environment);
