...
for (const key of [
  'STUDIO_AUTH_MODE',
  'STUDIO_AUTH_REGISTRATION_MODE',
  'STUDIO_AUTH_DB_PATH',
  'STUDIO_AUTH_SESSION_TTL_MS',
  'STUDIO_AUTH_PASSWORD_MIN_LENGTH',
  'STUDIO_AUTH_LOGIN_MAX_FAILURES',
  'STUDIO_AUTH_LOGIN_FAILURE_WINDOW_MS',
  'STUDIO_AUTH_GLOBAL_LOGIN_MAX_ATTEMPTS',
  'STUDIO_AUTH_LOGIN_MAX_CONCURRENCY',
  'STUDIO_AUTH_LOGIN_MAX_BODY_BYTES',
  'STUDIO_PROVIDER_BASE_URL',
  'STUDIO_PROVIDER_TYPE',
